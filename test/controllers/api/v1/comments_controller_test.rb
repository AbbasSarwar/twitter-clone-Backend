...
class Api::V1::CommentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create api_v1_comment" do
    assert_difference("Api::V1::Comment.count") do
      post api_v1_comments_url, params: { api_v1_comment: { text: @api_v1_comment.text, users_id: @api_v1_comment.users_id } }, as: :json
    end
  ...
  test "should update api_v1_comment" do
    patch api_v1_comment_url(@api_v1_comment), params: { api_v1_comment: { text: @api_v1_comment.text, users_id: @api_v1_comment.users_id } }, as: :json
    assert_response :success
  end
